    ...
    <div className="pointer-events-none fixed inset-x-0 top-4 z-50 flex flex-col items-center gap-3">
      {toasts.map((toast, index) => (
        <div
          ...
          className={`pointer-events-auto w-full max-w-sm rounded-xl border border-emerald-200 bg-white/95 p-4 shadow-lg backdrop-blur transition-all duration-300 ${
