  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
      <div className="mb-3 flex items-center justify-between">
        <h3 className="text-sm font-semibold text-slate-700">Fear & Greed Index</h3>
      ...
      <div className="relative mx-auto mb-4 h-24 w-48">
        ...
        {/* Needle */}
        <div 
          className="absolute bottom-0 left-1/2 h-20 w-1 origin-bottom -translate-x-1/2 bg-slate-800 transition-transform duration-500"
          style={{ transform: `translateX(-50%) rotate(${rotation}deg)` }}
        >
          <div className="absolute -top-1 left-1/2 h-3 w-3 -translate-x-1/2 rounded-full bg-slate-800" />
        </div>
        
        {/* Center cover */}
        <div className="absolute bottom-0 left-1/2 h-8 w-8 -translate-x-1/2 rounded-full bg-white shadow" />
      </div>
